    ...
    <div className="w-full min-h-screen h-screen">
      ...
      <main className="flex-1 h-full flex flex-col sm:flex-row">
        ...
        <div className="flex-1 pt-10">
          <div className="w-full justify-center lg:w-2/4 flex flex-col items-center lg:items-start lg:flex-row flex-wrap lg:justify-between mx-auto">
            <div
              className={
            ...
            {mainCategory && (
              <>
                <div className="fade-in-down z-50 mb-5 xl:mb-16 mt-5 lg:mt-0">
                  <Dropdown
                    data={
                      mainCategory === "kucanstvo"
                        ? homeCategory
                ...
                <div className="flex flex-col items-center lg:items-end lg:flex-row flex-wrap justify-center lg:justify-between w-full gap-5 fade-in-down">
                  {mainCategory === "kucanstvo"
                  ...
                  <div className="w-40 space-y-2 flex flex-col justify-end">
                    ...
                    <div className="max-w-full h-9 flex flex-row items-center relative shadow-md rounded-md mb-10">
